...
class User extends CI_Controller {
	...
	public function dt_user()
	{
		...
		if ($data) {
			...
			foreach ($data as $row) {
				...
				$delete = '<a href="javascript:;" title="delete user" class="delete-user btn btn-danger btn-xs" data-username="'.$row->username.'"> <i class="fa fa-trash"></i> </a>';
	...
	public function delete_user()
	{
		...
		$delete = $this->Main_Model->delete_data('tb_user', ['username' => $username]);
