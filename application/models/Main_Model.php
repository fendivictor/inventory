...
class Main_Model extends CI_Model {
	...
	public function view_data_with_order($table, $condition, $multiple = 1, $order)
	{
		$result = $this->db->where($condition)->order_by($order)->get($table);
    ...
    public function dropdown_data($table, $condition, $id, $text)
	{
		$data = $this->view_data($table, $condition, 1);
